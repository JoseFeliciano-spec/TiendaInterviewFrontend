  ...
  const testimonials = [
    {
      name: "María González",
      role: "Emprendedora",
      content: "La mejor plataforma para mi tienda online. Pagos seguros y rápidos.",
      rating: 5
    },
    {
      name: "Carlos Rodríguez", 
      role: "CEO TechStart",
      content: "Integración perfecta con nuestro sistema. Excelente experiencia.",
      rating: 5
    },
    {
      name: "Ana Martínez",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="space-y-4">
                  ...
                  >
                    Descubre productos increíbles con pagos seguros, envío gratis y la mejor experiencia de compra online.
                  </motion.p>
                </div>
                ...
                >
                  <motion.button
                    whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(0, 130, 90, 0.3)" }}
                    whileTap={{ scale: 0.95 }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Ofrecemos la mejor experiencia de compra online con tecnología de vanguardia
              </p>
            </motion.div>
              ...
              {[
                {
                  icon: FiShield,
                  title: "Pagos Seguros",
                  description: "Tecnología de encriptación avanzada para proteger tus datos",
                  color: "#00825A"
                },
                {
                  icon: FiZap,
                  title: "Entrega Rápida",
                  description: "Recibe tus productos en tiempo récord con nuestro sistema logístico",
                  color: "#B0F2AE"
                },
                {
                  icon: FiHeart,
                  title: "Atención 24/7",
                  description: "Soporte personalizado las 24 horas, los 7 días de la semana",
                  color: "#99D1FC"
                }
              ].map((feature, index) => (
                <motion.div
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-[#2C2A29] mb-3">{feature.title}</h3>
              ...
              {products.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-[#2C2A29] mb-2">{product.name}</h3>
                    
                    <div className="flex items-center space-x-2 mb-4">
                      <span className="text-2xl font-bold text-[#00825A]">{product.price}</span>
            ...
            >
              <div className="flex justify-center mb-4">
                {[...Array(testimonials[currentTestimonial].rating)].map((_, i) => (
                  <FiStar key={i} size={24} className="text-[#DFFF61] fill-current" />
                ))}
              </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Únete a miles de clientes satisfechos y descubre por qué TiendaApp es la mejor opción para tus compras online.
              </p>

              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0 15px 35px rgba(0, 130, 90, 0.3)" }}
                whileTap={{ scale: 0.95 }}
